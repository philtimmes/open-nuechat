...
export default function Register() {
  ...
  // Force reload branding config on register page to get latest settings
  useEffect(() => {
    loadConfig(true);
  }, [loadConfig]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-background)] p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 -right-32 w-96 h-96 bg-[var(--color-primary)] opacity-10 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 -left-32 w-96 h-96 bg-[var(--color-secondary)] opacity-10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <p className="mt-8 text-center text-xs text-zinc-500/60">
